...
mixin _$FavoriteState<T> {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<QuestionsModel> questions) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(List<QuestionsModel> questions)? loaded,
...
abstract class _$$LoadedImplCopyWith<T, $Res> {
  ...
  @useResult
  $Res call({List<QuestionsModel> questions});
}
...
class _$LoadedImpl<T> implements Loaded<T> {
  const _$LoadedImpl(final List<QuestionsModel> questions)
