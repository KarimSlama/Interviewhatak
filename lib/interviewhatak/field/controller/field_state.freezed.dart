...
class __$$LoadingImplCopyWithImpl<T, $Res>
    extends _$FieldStateCopyWithImpl<T, $Res, _$LoadingImpl<T>>
...
abstract class Loading<T> implements FieldState<T> {
...
class __$$SuccessImplCopyWithImpl<T, $Res>
    extends _$FieldStateCopyWithImpl<T, $Res, _$SuccessImpl<T>>
...
class _$SuccessImpl<T> implements Success<T> {
  const _$SuccessImpl(final List<T> data) : _data = data;
  ...
  @override
  String toString() {
    return 'FieldState<$T>.success(data: $data)';
  }
...
abstract class Success<T> implements FieldState<T> {
  const factory Success(final List<T> data) = _$SuccessImpl<T>;
...
class __$$ErrorImplCopyWithImpl<T, $Res>
    extends _$FieldStateCopyWithImpl<T, $Res, _$ErrorImpl<T>>
...
abstract class Error<T> implements FieldState<T> {
